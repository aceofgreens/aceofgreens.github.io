...
In the medium run the real exchange rate can change even with a fixed currency. This is because the prices $P$ and $P^\ast$ can change. With a fixed currency rate $\bar{E}$ and when $i = i^\ast$, the IS relation becomes:
...
**Flexible exchange rates**. In reality the uncovered interest parity condition is as not as simple as described so far. We derived it only for 1 future year, but it should be valid of any number of future years. A more realistic version, for $n$ years ahead is:
...
1. Classical gold standard, 1815-1914. Currencies were defined in terms of gold, implying fixed exchange rates. There was effectively one *money*, which facilitated trade, investment, and international division of labor. Currencies being redeemable in gold limits inflation. If a country inflates its paper currency, $\epsilon$ increases and its trade balance worsens. Foreign countries then redeem their reserves for gold and there is a steady outflow of gold from the inflating currency.
...
3. The gold exchange standard (Britain and US), 1926-1931. Britain wanted to return to the gold standard not at the current par but at a pre-war parity, for the national "prestige". To set $\text{GBP}/\text{X}$ to a high value, where $\text{X}$ represents the other currency, Britain needed to set $\text{GBP}/\text{GOLD}$ to be high, which requires a huge deflation. But Britain did not want to deflate, as countries generally want to keep inflating. So the idea was to force other countries to redefine at very weak currencies, so that 
...
6. Bretton Woods unraveling, 1968-1971. The US had promised to convert gold at \$35 per troy ounce. European citizens could sell their dollars into gold in the free gold market. In order to keep the dollar at \$35 an ounce, the US had to support that price by leaking out gold from its dwindling stock. A specially-designed two-tiered gold system did not improve the situation.
